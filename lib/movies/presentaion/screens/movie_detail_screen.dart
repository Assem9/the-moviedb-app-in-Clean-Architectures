...
import 'package:movies_app/movies/presentaion/controller/movies_details_bloc.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => MoviesDetailsBloc(getIt(),getIt(),)
...
class MovieDetailContent extends StatelessWidget {
      ...
      builder: (context, state) {
        print(
            state.recommendations.length.toString()
                +'-'+
                state.movieRequestState.toString()+' reco ${state.recommendationState}'
        );
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MoviesDetailsBloc, MoviesDetailsState>(
      builder: (context, state) {
        print('recommendations=>${state.recommendations.length}-${state.recommendationState}');
    return SliverGrid(
        ...
        (context, index) {
          ...
          return FadeInUp(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: ApiConstants.imageUrl(state.recommendations[index].backdropPath!),
